...
<div class="center scaffold">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#D" data-toggle="tab">Successful Logouts</a></li>
        <li><a href="#E" data-toggle="tab">Password Changes</a></li>
        <li><a href="#F" data-toggle="tab">Reset Passwords</a></li>
    </ul>
